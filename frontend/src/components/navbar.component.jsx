...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="navbar">
        ...
        <div className={"absolute lbg-white w-full left-0 top-full mt-05 border-b border-grey py-4 px-[5vw] md:border-0 md:block md:relative md:inset-0 md:p-0 md:w-auto md:show " +
        (
           searchBoxVisibliity ? "show" : "hide"
           )}>
        ...
        <div className="flex items-center gap-3 md:gap-6 ml-auto">
          ...
          <button className="md:hidden bg-grey w-12 h-12 rounded-full
           ...
           onClick={()=>{ setSearchBoxVisibliity (currentVal => !currentVal)}}>
            <i className="fi fi-rr-search text-xl"></i>
            </button>

            <Link to="/editor" className="hidden_md:flex gap-2 link">
